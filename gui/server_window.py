...
from PyQt6.QtWidgets import (
    ...
    QPushButton, QLabel, QSystemTrayIcon, QTextEdit,
...
from app.i18n import load_catalog, to_display_locale
from gui.server_process import ServerThread, kill_process_on_port
from gui.server_settings import (
...
from gui.server_tray import create_server_tray
from gui.server_window_view import show_toast as show_window_toast
...
class ServerWindow(QMainWindow):
    ...
    def _resolve_locale(self, preference: str) -> str:
        return resolve_locale(preference)
    ...
    def _apply_language_preference(self, preference: str, persist: bool = True) -> None:
        apply_language_preference(self, preference, persist=persist)
    ...
    def create_tray_icon(self):
        ...
        (
            ...
            self._tray_start_action,
            self._tray_stop_action,
            self._tray_quit_action,
        ) = create_server_tray(self)
    ...
    def show_toast(self, message: str, toast_type: str = "info", duration: int = 3000):
        """토스트 알림 표시"""
        show_window_toast(self, ToastWidget, message, toast_type, duration)
